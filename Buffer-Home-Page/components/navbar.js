          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="nav-a">
            <li class="nav-item dropdown">
                ...
                <p class ="Publishing">Plan,collobrate,and publish </br>thumb-stopping contant </p></li>
                  ...
                  <li><a class="dropdown-item" href="../AnalaticsPage/analytics.html" > <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bar-chart" viewBox="0 0 16 16">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="%20us/About%20Us-III/About.html">About</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="../AnalaticsPage/customers.html">Customers</a>
              </li>
          </ul>
          <form class="d-flex" role="search">
            <!-- <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search"> -->
          <a href="../AnalaticsPage/login.html">Log In</a>
          <button type="button" class="btn btn-primary"><a class="signup" href="../AnalaticsPage/signup.html">Get Started Now</a ></button>
          </form>
        </div>
      </div>
    </nav>
